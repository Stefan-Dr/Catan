  ...
  , m_game(new Game())
{
  ...
  connect(dynamic_cast<Board*>(m_board),
          &Board::manageResourcesHouse,
          this,
          &MainWindow::manageResourcesHouse);
  connect(dynamic_cast<Board*>(m_board),
          &Board::manageResourcesRoad,
          this,
          &MainWindow::manageResourcesRoad);
  connect(dynamic_cast<Board*>(m_board),
          &Board::manageResourcesCity,
          this,
  ...
  // &MainWindow::AddNewBlankNode); connect(this, &MainWindow::AddedNewBlankNode,
  // dynamic_cast<Board *>(m_board));
}
