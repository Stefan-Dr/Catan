...
MainWindow::MainWindow (QWidget *parent)
    : QMainWindow (parent), ui (new Ui::MainWindow),
      m_board (new Board (this)), m_dice (new Dice ())
...
void
MainWindow::displayBankResources ()
{
  Bank *bank = m_game->getBank ();

  ui->lbBrickBank->setText (
      QString::number (bank->get_num_of_brick_from_bank ()));
  ui->lbStoneBank->setText (
      QString::number (bank->get_num_of_stone_from_bank ()));
  ui->lbWheatBank->setText (
      QString::number (bank->get_num_of_wheat_from_bank ()));
  ui->lbWoodBank->setText (
      QString::number (bank->get_num_of_wood_from_bank ()));
  ui->lbWoolBank->setText (
      QString::number (bank->get_num_of_wool_from_bank ()));
}

void
MainWindow::displayPlayerPoints ()
{
...
void
MainWindow::on_pbStartGame_clicked ()
{
  ui->stackedWidget->setCurrentIndex (3);
}

void
MainWindow::on_pbSettings_clicked ()
{
  ui->stackedWidget->setCurrentIndex (1);
}

void
MainWindow::on_pbBackToMenu_clicked ()
{
  ui->stackedWidget->setCurrentIndex (0);
}
void
MainWindow::on_pbBackToMenu_2_clicked ()
{
  ui->stackedWidget->setCurrentIndex (0);
}

void
MainWindow::on_pbHelp_clicked ()
{
...
void
MainWindow::on_pbBackToMenu_3_clicked ()
{
...
void
MainWindow::on_pbContinue_clicked ()
{
  bool con1 = false;
  bool con2 = false;
  bool con3 = false;
  ...
  if (ui->lePlayer1->text ().length () < 2
    ...
    {
      ui->lbPlayer1Required->setText (
          "Name length must be within 2-13 letters!");
    }
  else
    {
      con1 = true;
...
void
MainWindow::on_pbRollDice_clicked ()
{
      ...
      switch (d1)
        ...
        case 1:
          ui->wDice1->setStyleSheet (
              "border-image: url(:/resources/images/dice1.png) 0 0 0 0 "
              "stretch stretch;");
          break;
        case 2:
          ui->wDice1->setStyleSheet (
              "border-image: url(:/resources/images/dice2.png) 0 0 0 0 "
              "stretch stretch;");
          break;
        case 3:
          ui->wDice1->setStyleSheet (
              "border-image: url(:/resources/images/dice3.png) 0 0 0 0 "
              "stretch stretch;");
          break;
        case 4:
          ui->wDice1->setStyleSheet (
              "border-image: url(:/resources/images/dice4.png) 0 0 0 0 "
              "stretch stretch;");
          break;
        case 5:
          ui->wDice1->setStyleSheet (
              "border-image: url(:/resources/images/dice5.png) 0 0 0 0 "
              "stretch stretch;");
          break;
        case 6:
          ui->wDice1->setStyleSheet (
              "border-image: url(:/resources/images/dice6.png) 0 0 0 0 "
              "stretch stretch;");
          break;
        }
...
void
MainWindow::on_rbON_toggled (bool checked)
{
  // if ( checked ) { m_music->play(); }
}

void
MainWindow::on_rbOFF_toggled (bool checked)
{
  // if ( checked ) { m_music->stop(); }
}

void
MainWindow::on_pb_House_clicked ()
{
      ...
      if (m_game->can_build_house ())
        {
          ...
          // m_game->BuildHouse();
          m_board->setCurrColor (
              m_game->getCurrentPlayer ()->get_player_color ());
          //            displayResources();
          //            displayBankResources();
          //            displayPlayerPoints();
          //            ui->lbError->setText("");
...
void
MainWindow::on_pb_Settlement_clicked ()
{
  if (m_dice->get_dice_is_rolled () == true)
    {
      if (m_game->can_build_city ())
        {
          ...
          //            m_game->BuildCity();
          m_board->setCurrColor (
              m_game->getCurrentPlayer ()->get_city_color ());
          //            displayResources();
          //            displayBankResources();
          //            displayPlayerPoints();
          //            ui->lbError->setText("");
...
void
MainWindow::on_pb_MagicCard_clicked ()
{
  if (m_dice->get_dice_is_rolled () == true)
    {
          ...
          if (m_game->win ())
            {
              ...
              msgBox.setText ("CONGRATS "
                              + QString::fromStdString (
                                  m_game->getCurrentPlayer ()->get_name ())
                              + ", YOU WON");
              int ret = msgBox.exec ();
              if (ret == QMessageBox::Ok)
                {
