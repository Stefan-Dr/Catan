...
// getters
std::string
Player::get_name () const
{
  return m_name;
}

int
Player::get_num_of_wood () const
{
  return m_num_of_wood;
}
int
Player::get_num_of_brick () const
{
  return m_num_of_brick;
}
int
Player::get_num_of_wool () const
{
  return m_num_of_wool;
}
int
Player::get_num_of_wheat () const
{
  return m_num_of_wheat;
}
int
Player::get_num_of_stone () const
{
  return m_num_of_stone;
}

int
Player::get_num_of_allowed_houses () const
{
  return m_num_of_allowed_houses;
}
int
Player::get_num_of_allowed_cities () const
{
  return m_num_of_allowed_cities;
}
int
Player::get_num_of_allowed_roads () const
{
  return m_num_of_allowed_roads;
}

QColor
Player::get_player_color () const
{
  return m_player_color;
}

QColor
Player::get_city_color () const
{
  return m_city_color;
}
...
int
Player::get_victory_points () const
{
  return m_victory_points;
}
int
Player::get_num_of_houses () const
{
  return m_num_of_houses;
}
int
Player::get_num_of_cities () const
{
  return m_num_of_cities;
}
int
Player::get_num_of_roads () const
{
  return m_num_of_roads;
}
std::unordered_map<ResourceType, int> &
Player::get_PlayerResources ()
{
  return m_player_resource;
}

bool
Player::get_first_turn () const
{
  return m_first_turn;
}

void
Player::set_first_turn (bool value)
{
  m_first_turn = value;
}

void
Player::set_name (std::string new_name)
{
  m_name = new_name;
}
void
Player::set_PlayerResources (
...
bool
Player::give_resource_card_to_player (ResourceType res_type, int amount,
                                      Player &p)
{
...
void
Player::take_resource_card_from_bank (ResourceType res_type, int amount,
                                      Bank &bank)
{
  // m_player_resource[res_type]+=amount;
...
void
Player::return_resource_card_to_bank (ResourceType res_type, int amount,
                                      Bank &bank)
{
  for (int i = 0; i < amount; i++)
    {
...
void
Player::increase_num_of_houses ()
{
  m_num_of_houses++;
}
void
Player::decrease_num_of_houses ()
{
  m_num_of_houses--;
}
void
Player::increase_num_of_cities ()
{
  m_num_of_cities++;
}
void
Player::increase_num_of_roads ()
{
  m_num_of_roads++;
}

void
Player::increase_victory_points (int amount)
{
  m_victory_points += amount;
}
void
Player::increase_allowed_house_number ()
{
  m_num_of_allowed_houses++;
}
void
Player::decrease_allowed_house_number ()
{
  m_num_of_allowed_houses--;
}
// allowed promeni na to
void
Player::decrease_allowed_city_number ()
{
  m_num_of_allowed_cities--;
}
void
Player::decrease_allowed_road_number ()
{
...
bool
Player::comparePlayers (const Player *pl1, const Player *pl2)
{
