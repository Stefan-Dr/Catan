...
bool
Player::give_resource_card_to_player(ResourceType res_type,
                                     int amount,
                                     Player& p)
{
...
void
Player::take_resource_card_from_bank(ResourceType res_type,
                                     int amount,
                                     Bank& bank)
{
  // m_player_resource[res_type]+=amount;
...
void
Player::return_resource_card_to_bank(ResourceType res_type,
                                     int amount,
                                     Bank& bank)
{
  for (int i = 0; i < amount; i++) {
