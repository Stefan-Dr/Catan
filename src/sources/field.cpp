...
Field::Field(int id, int number, ResourceType res_type, Node *up_corner, Node *bottom_corner, Node *bottom_right_corner,
             Node *bottom_left_corner, Node *up_right_corner, Node *up_left_corner, Road *right_edge, Road *left_edge,
             Road *bottom_right_edge, Road *bottom_left_edge, Road *up_right_edge, Road *up_left_edge)
    : m_id(id), m_number(number), m_res_type(res_type), m_up_corner(up_corner), m_down_corner(bottom_corner),
      m_bottom_right_corner(bottom_right_corner), m_bottom_left_corner(bottom_left_corner),
      m_up_right_corner(up_right_corner), m_up_left_corner(up_left_corner), m_right_edge(right_edge),
      m_left_edge(left_edge), m_bottom_right_edge(bottom_right_edge), m_bottom_left_edge(bottom_left_edge),
      m_up_right_edge(up_right_edge), m_up_left_edge(up_left_edge), m_is_robber_od_the_field(false)
{
    ...
    m_edges = {m_up_left_edge, m_left_edge, m_bottom_left_edge, m_bottom_right_edge, m_right_edge, m_up_right_edge};
}

Field::Field(int id, int number, Node *up_left_corner, Node *up_corner, Node *up_right_corner,
             Node *bottom_right_corner, Node *bottom_corner, Node *bottom_left_corner)
    : m_id(id), m_number(number), m_up_corner(up_corner), m_down_corner(bottom_corner),
      m_bottom_right_corner(bottom_right_corner), m_bottom_left_corner(bottom_left_corner),
