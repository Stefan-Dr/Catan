...
// constructor
GUI_Road::GUI_Road(GUI_Node *start, GUI_Node *end) : QGraphicsLineItem(), m_start(start), m_end(end)
{
}
...
{
    return QPointF(
        m_start->CenterPosition().rx() - (m_start->CenterPosition().rx() - m_end->CenterPosition().rx()) / 2.0,
