...
Game::Game ()
    : m_player1 (new Player (1, "", Qt::blue, Qt::darkBlue)),
      ...
      m_currentPlayer (m_player1), m_bank (new Bank ())
/*, m_board(new Board())*/ {
...
void Game::BuildHouse (/*Node* node*/)
{
  ...
  m_currentPlayer->return_resource_card_to_bank (ResourceType::Wood, 1,
                                                 *m_bank);
  ...
  m_currentPlayer->return_resource_card_to_bank (ResourceType::Wheat, 1,
                                                 *m_bank);
  m_currentPlayer->return_resource_card_to_bank (ResourceType::Wool, 1,
                                                 *m_bank);
...
void
Game::trade_with_bank (ResourceType player_resource,
                       ResourceType bank_resource)
{
