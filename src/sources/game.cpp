...
// constructor
Game::Game()
    : m_player1(new Player(1, "", Qt::blue, Qt::darkBlue)), m_player2(new Player(2, "", Qt::yellow, Qt::darkYellow)),
      m_player3(new Player(3, "", Qt::green, Qt::darkGreen)), m_player4(new Player(4, "", Qt::red, Qt::darkRed)),
...
{
    if (m_currentPlayer->get_num_of_wood() >= 1 && m_currentPlayer->get_num_of_wool() >= 1 &&
        m_currentPlayer->get_num_of_wheat() >= 1 && m_currentPlayer->get_num_of_brick() >= 1)
    {
        return true;
    }
    else
...
{
    if (m_currentPlayer->get_num_of_wheat() >= 2 && m_currentPlayer->get_num_of_stone() >= 3)
    {
        return true;
    }
    else
...
{
    if (m_currentPlayer->get_num_of_wood() >= 1 && m_currentPlayer->get_num_of_brick() >= 1)
    {
        return true;
    }
    else
