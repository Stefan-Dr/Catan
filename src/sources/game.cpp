...
// getters
Player*
Game::getPlayer1() const
{
  return m_player1;
}
Player*
Game::getPlayer2() const
{
  return m_player2;
}
Player*
Game::getPlayer3() const
{
  return m_player3;
}
Player*
Game::getPlayer4() const
{
  return m_player4;
}
Bank*
...
// setters
void
Game::setPlayer1(Player* player1)
{
  m_player1 = player1;
}
void
Game::setPlayer2(Player* player2)
{
  m_player2 = player2;
}
void
Game::setPlayer3(Player* player3)
{
  m_player3 = player3;
}
void
Game::setPlayer4(Player* player4)
{
  m_player4 = player4;
}
void
Game::setBank(Bank* bank)
{
  m_bank = bank;
}
void
Game::setCurrentPlayer(Player* player)
{
  m_currentPlayer = player;
}

auto
Game::currentPlayerId() const -> int
{
...
void Game::BuildHouse(/*Node* node*/)
{
  ...
  m_currentPlayer->return_resource_card_to_bank(
    ResourceType::Brick, 1, *m_bank);
  m_currentPlayer->return_resource_card_to_bank(
    ResourceType::Wheat, 1, *m_bank);
...
void Game::BuildCity(/*Node* node*/)
{
  ...
  m_currentPlayer->return_resource_card_to_bank(
    ResourceType::Wheat, 2, *m_bank);
  m_currentPlayer->return_resource_card_to_bank(
    ResourceType::Stone, 3, *m_bank);
...
bool
Game::can_trade_with_bank(ResourceType player_resource,
...
void
Game::trade_with_bank(ResourceType player_resource, ResourceType bank_resource)
{
...
void
Game::Turn(int result, Board* board)
{
  ...
  for (auto& i : board->m_fields) {
    ...
    if (result == i->get_number()) {
      ...
      // bacenih kockica if(!i->is_robber_on_the_field()){ ako se na tom polju ne
      // nalazi lopov radimo sledece std::cout << i->get_id() << std::endl;
...
void
Game::set_can_build_house(bool value)
{
  m_can_build_house = value;
}

void
Game::set_can_build_city(bool value)
{
  m_can_build_city = value;
}

bool
Game::get_can_build_house() const
{
  return m_can_build_house;
}

bool
Game::get_can_build_city() const
{
  return m_can_build_city;
}

bool
Game::can_build_house()
{
