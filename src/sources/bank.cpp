...
unsigned Bank::get_num_of_brick_from_bank() const { return m_num_of_brick; }
unsigned Bank::get_num_of_wood_from_bank() const { return m_num_of_wood; }
unsigned Bank::get_num_of_wool_from_bank() const { return m_num_of_wool; }
unsigned Bank::get_num_of_wheat_from_bank() const { return m_num_of_wheat; }
unsigned Bank::get_num_of_stone_from_bank() const { return m_num_of_stone; }
