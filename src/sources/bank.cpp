...
{
  m_bank_resource[ResourceType::Wood]
      = 19; // 19 resources type wood at the start of the game
  m_bank_resource[ResourceType::Brick]
      = 19; // 19 resources type brick at the start of the game
  m_bank_resource[ResourceType::Wool]
      = 19; // 19 resources type wool at the start of the game
  m_bank_resource[ResourceType::Wheat]
      = 19; // 19 resources type wheat at the start of the game
  m_bank_resource[ResourceType::Stone]
      = 19; // 19 resources type stone at the start of the game
}

// getters
std::unordered_map<ResourceType, unsigned> &
Bank::get_bank_resources ()
{
  return m_bank_resource;
}

unsigned
Bank::get_num_of_brick_from_bank () const
{
  return m_num_of_brick;
}
unsigned
Bank::get_num_of_wood_from_bank () const
{
  return m_num_of_wood;
}
unsigned
Bank::get_num_of_wool_from_bank () const
{
  return m_num_of_wool;
}
unsigned
Bank::get_num_of_wheat_from_bank () const
{
  return m_num_of_wheat;
}
unsigned
Bank::get_num_of_stone_from_bank () const
{
...
void
Bank::add_resource_card (ResourceType res_type, int num_cards)
{
...
void
Bank::remove_resource_card (ResourceType res_type, int num_cards)
{
  m_bank_resource[res_type] -= num_cards;
  if (res_type == ResourceType::Brick)
    {
