...
// getters
bool GUI_Node::get_hasRoad() const { return hasRoad; }

bool GUI_Node::get_is_city_built() const { return m_is_city_built; }

bool GUI_Node::get_is_end_of_road() const { return m_is_end_of_road; }

Node *GUI_Node::getNode() const { return m_node; }

bool GUI_Node::get_is_house_built() const { return m_is_house_built; }

// setters
void GUI_Node::set_is_end_of_road(bool value) { m_is_end_of_road = value; }

void GUI_Node::set_is_city_built(bool value) { m_is_city_built = value; }

void GUI_Node::set_hasRoad(bool x) { hasRoad = x; }

void GUI_Node::setNode(Node *newNode) { m_node = newNode; }

void GUI_Node::set_is_house_built(bool value) { m_is_house_built = value; }

QColor GUI_Node::m_color = QColor("white");

QRectF GUI_Node::boundingRect() const { return QRectF(0, 0, 36, 36); }

QRectF GUI_Node::position() const { return QRectF(0, 0, 36, 36); }

void GUI_Node::paint(QPainter *painter, const QStyleOptionGraphicsItem *option,
                     QWidget *widget) {
  Q_UNUSED(option)
  Q_UNUSED(widget)
  ...
  else if (m_brush == Qt::blue || m_brush == Qt::green ||
           m_brush == Qt::yellow || m_brush == Qt::red) {
...
QPointF GUI_Node::CenterPosition() { return pos() + QPointF(18, 18); }
...
int GUI_Node::type() const { return 1; }
