...
// constructor
Node::Node(int m_id)
    : m_id(m_id), m_is_house_built(false), m_is_city_built(false), m_owner(0),
      m_can_build(false) {}
...
bool Node::get_can_build_city() const { return m_can_build_city; }
...
void Node::set_can_build_city(bool value) { m_can_build_city = value; }
