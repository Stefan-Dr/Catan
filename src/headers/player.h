...
public:
  ...
  bool give_resource_card_to_player(ResourceType res_type,
                                    int amount,
                                    Player& p);
  void take_resource_card_from_bank(ResourceType res_type,
                                    int amount,
                                    Bank& bank);

  void return_resource_card_to_bank(ResourceType res_type,
                                    int amount,
                                    Bank& bank);
